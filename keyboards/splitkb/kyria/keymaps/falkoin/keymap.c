...
enum custom_keycodes {
 ...
 [_LAYER0] = LAYOUT(
    ...
    MO(3),  KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO,   KC_NO, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSL(4),
                   KC_NO , KC_LALT, KC_LGUI, KC_LSFT, KC_NO,   KC_NO, MO(1), KC_SPC, MO(2), KC_NO),
...
[_LAYER2] = LAYOUT(KC_0, KC_1, KC_2, KC_3, KC_4, KC_5,                                                           KC_6, KC_7, KC_8, KC_9, KC_TRNS, KC_TRNS,
                   KC_TILD, KC_TRNS, KC_LCBR, KC_LBRC, KC_LPRN, KC_UNDS,                                         KC_EQL, KC_RPRN, KC_RBRC, KC_RCBR, KC_QUOT, KC_DQUO,
...
[_LAYER3] = LAYOUT(
        ...
        KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS,                                     KC_TAB,  KC_BSPC, KC_DEL,  KC_ENT,  KC_SPC,  KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

[_LAYER4] = LAYOUT(KC_TAB, HYPR(KC_Q), HYPR(KC_W), HYPR(KC_E), HYPR(KC_R), HYPR(KC_T), HYPR(KC_Y), HYPR(KC_U), HYPR(KC_I), HYPR(KC_O), HYPR(KC_P), KC_MINS, KC_ESC, HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G), HYPR(KC_H), HYPR(KC_J), HYPR(KC_K), HYPR(KC_L), HYPR(KC_SCLN), KC_QUOT, KC_LCTL, HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B), KC_VOLD, KC_MUTE, KC_NO, KC_VOLU, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS, KC_NO, MO(1), SC_SENT, MO(3), KC_NO, KC_NO, MO(4), KC_SPC, MO(2), KC_NO)
